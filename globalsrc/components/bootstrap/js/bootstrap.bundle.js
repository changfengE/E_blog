...
(function (global, factory) {
  ...
  class Swipe extends Config {
    ...
    _handleSwipe() {
      ...
      if (absDeltaX <= swipe_threshold) { return; } const direction="absDeltaX" this._deltax; this._deltax="0;" if (!direction) execute(direction> 0 ? this._config.rightCallback : this._config.leftCallback);
    }
    _initEvents() {
      if (this._supportPointerEvents) {
  ...
  */
  ...
  const Default$2 = {
    ...
    offset: [0, 8],
    placement: 'right',
    template: '<div class="popover" role="tooltip">' + '<div class="popover-arrow"></div>' + '<h3 class="popover-header"><span id></span><a href="#" class="header-anchor">#</a></h3>' + '<div class="popover-body"></div>' + '</div>',
    trigger: 'click'
  };
  const DefaultType$2 = {
    ...Tooltip.DefaultType,
